    ...
    <body>
        <div class="sidebar">
            <div class="sidebar-brand">
                <img src="../images/robinlogo-white.svg" alt="">
            </div>
            <div class="sidebar-menu">
                <div class="sidebar-add">
                    <i class="fas fa-user-plus"></i>
                    <span class="font-size-24">Add person</span>
                </div>
                <hr class="sidebar-divider">
                <div class="sidebar-search">
                    <p class="font-size-18">Search person</p>
                    <input type="search" placeholder="Search person">
                </div>
                <div class="sidebar-arrange">
                    <p class="font-size-18">Arrange By</p>
                    <div class="custom-select-wrapper">
                        <div class="custom-select">
                            <div class="custom-select__trigger"><span>Name</span>
                                <div class="arrow"></div>
                            </div>
                            <div class="custom-options">
                                <span class="custom-option selected custom-option__top" data-value="name">Name</span>
                                <span class="custom-option" data-value="birthday">Birthday</span>
                                <span class="custom-option custom-option__bottom" data-value="task">Soonest task</span>
                            </div>
                        </div>
                    </div>
                </div>
